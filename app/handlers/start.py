...
async def build_cabinet_text(session: AsyncSession, user: User) -> str:
    ...
    return (
        "🎧 <b>TG Music</b> — вся музыка в Телеграме\n\n"
        "<b>Просто напишите название или исполнителя</b> — прямо сюда, в чат. "
        "Найду за секунды и пришлю в mp3 с обложкой.\n"
        "Ищет по автору, названию, даже по паре букв — и по-русски, и латиницей.\n\n"
        "🆓 <b>В боте всё бесплатно:</b> поиск, прослушивание, скачивание, "
        "своя библиотека, загрузка своих треков.\n\n"
        f"💎 <b>🎧 Открыть плеер</b> — полноценное приложение за {settings.premium_price_rub} ₽/мес: "
        "миксы под настроение, плейлисты, карточки артистов, эквалайзер, "
        "тексты песен, офлайн-режим. <b>Первый день — бесплатно.</b>\n\n"
        f"{subscription} · треков в библиотеке: {library_count}\n\n"
        "💡 Плеер можно <b>вынести на рабочий стол</b> и слушать без Телеграма — "
        "как обычное приложение. Он <b>играет в фоне</b>, когда свёрнут."
    )
