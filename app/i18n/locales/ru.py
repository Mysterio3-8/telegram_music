...
MESSAGES: dict[str, str] = {
    ...
    "original.caption": "🎚 Оригинальное качество: {format}, {size} МБ",
    "menu.settings": "⚙️ Настройки",
    "settings.title": "<b>⚙️ Настройки</b>",
    "settings.quality_hint": "Формат, в котором приходят треки.\n\n<b>MP3</b> — быстро, небольшой файл, играет прямо в плеере Telegram.\n<b>Оригинал</b> — тот файл, который загрузил автор, часто WAV или FLAC. Приходит отдельным файлом вторым сообщением, весит десятки мегабайт и есть не у всех треков: где автор скачивание не разрешил, придёт обычный mp3.",
    "settings.quality_mp3": "🎵 MP3",
    "settings.quality_original": "🎚 Оригинал (Premium)",
    "settings.quality_premium_only": "Оригинальное качество доступно по подписке Premium.",
    "settings.quality_saved_mp3": "Готово: треки приходят в mp3",
    "settings.quality_saved_original": "Готово. Оригинал придёт вторым сообщением — там, где автор разрешил скачивание. Где не разрешил, останется обычный mp3.",
