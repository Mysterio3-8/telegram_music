...
MESSAGES: dict[str, str] = {
    ...
    "remind.comeback_trial": "👋 Давно не виделись! В плеере вас ждут {days} дней Premium бесплатно — без оплаты, включаются сами при первом открытии.",
    "remind.comeback": "👋 Давно не виделись! Напишите сюда название любого трека — пришлю его за пару секунд.",
    ...
    "gate.text": (
        "🎵 Для использования Infinity Music подпишитесь на наши каналы.\n\n"
    ...
    "album.section": "💿 Альбомы",
    "album.button": "💿 {artist} — {title} · {count} тр.",
    "album.header": "💿 {artist} — {title}\n{count} тр.\n\nВыберите трек или скачайте альбом целиком.",
    "album.download_all": "⬇️ Скачать весь альбом ({count})",
    "album.back": "◀️ К результатам",
    "album.loading": "💿 Открываю альбом…",
    "album.empty": "Не удалось открыть альбом — попробуйте позже.",
    "album.premium_only": "Альбом целиком — с Premium. Треки по одному скачиваются бесплатно.",
    "album.premium_button": "💎 Открыть Premium",
    "album.already": "Альбом уже качается — дождитесь окончания.",
    "album.queued": "⬇️ Качаю «{title}»: {count} тр., около {minutes} мин. Треки придут сюда по мере готовности.",
    "album.progress": "⬇️ «{title}»: {done} из {count}",
    "album.done": "✅ «{title}» готов: {ok} из {count}.",
    "album.failed": "Не удалось скачать: {names}",
    "quick.already_fetching": "Этот трек уже качаю — придёт через несколько секунд",
    "quality.note_high": "🎚 Лучшее доступное качество · {format} · {size} МБ",
    "quality.note_lossless": "🎚 Оригинал автора · {format} · {size} МБ",
    "quick.preparing_best": "Готовлю в лучшем качестве — пришлю сюда",
    "menu.settings": "⚙️ Настройки",
    "settings.title": "<b>⚙️ Настройки</b>",
    "settings.quality_hint": "Качество, в котором приходят треки.\n\n<b>Обычное</b> — mp3 128 kbps, как сейчас у всех.\n<b>Лучшее</b> — максимум, который отдаёт источник: 160 kbps, а у части треков оригинальный файл автора (WAV или FLAC). Занимает на несколько секунд дольше и весит больше.",
    "settings.quality_mp3": "🎵 Обычное · mp3 128",
    "settings.quality_best": "🎚 Лучшее качество (Premium)",
    "settings.quality_premium_only": "Лучшее качество доступно по подписке Premium.",
    "settings.quality_saved_mp3": "Готово: треки приходят как раньше",
    "settings.quality_saved_best": "Готово. Теперь треки приходят в лучшем, что отдаёт источник: оригинал автора там, где он есть, иначе 160 kbps вместо 128. Где недоступно ни то ни другое, придёт обычный файл — без ошибок и ожидания.",
    "settings.back": "◀️ Назад",
    "settings.cover_hint": "<b>Обложка</b> и так вшита в файл и видна в плеере. Отдельной картинкой её стоит включать, если складываете музыку в свою медиатеку.",
    "settings.cover_on": "🖼 Обложка отдельно — включена",
    "settings.cover_off": "🖼 Обложка отдельно — выключена",
    # --- карточка трека
    "card.title": "🎧 {title}",
    ...
    # --- загрузка трека
    "upload.intro": "⬆️ <b>Загрузка музыки</b>\n\n📎 <b>Аудиофайлом</b> — пришлите трек файлом. Столько треков, сколько хотите, хоть всю коллекцию по очереди — это <b>бесплатно и без лимитов</b>.\n\n🔗 <b>Ссылкой</b> — с YouTube Music, SoundCloud и других площадок: нужна <b>💎 Premium</b>-подписка.\n\n⚠️ Указывайте исполнителя — иначе трек станет «Неизвестным».\n\nЖду файл или ссылку 👇",
    ...
    "upload.premium_bulk": "Загрузка по ссылке — только для 💎 Premium.\nАудиофайлом можно грузить бесплатно и без лимитов — пришлите трек файлом.",
    "upload.reading_link": "🔍 Читаю ссылку…",
    "upload.link_failed": "Не удалось открыть эту ссылку. Проверьте её и попробуйте ещё раз.",
    "upload.queued_link": "⏳ Принято! Скачаем трек и пришлём сюда — обычно меньше минуты.",
    "upload.drm_service": "🔒 <b>{service}</b> отдаёт только защищённый поток — самого файла там нет.\n\nЗато список треков читается: «Перенос» найдёт те же песни в доступных источниках и сложит их в вашу библиотеку.",
    "upload.go_transfer": "🔄 Перенести плейлист",
    ...
    "premium.method_title": "<b>Premium на {label}</b>\n\nЧем платите?\n\n⭐ <b>{stars} Stars</b> — прямо в Telegram, без карты\n💳 <b>{price} ₽</b> — карта или СБП",
    "premium.pay_stars": "⭐ Оплатить {stars} Stars",
    "premium.pay_rub": "💳 Оплатить {price} ₽",
    ...
    "transfer.intro": (
        ...
        "Пришлите ссылку на плейлист — <b>Spotify</b>, <b>Яндекс.Музыка</b> "
        "или <b>ВКонтакте</b>.\n\n"
    ...
    "transfer.parse_failed": "Не удалось прочитать плейлист по этой ссылке.",
    "transfer.no_tracks": "В плейлисте не нашлось треков — проверьте, что он открыт для всех.",
    "transfer.more": "\n…и ещё {count}",
    ...
    "contest.open_app": "🎧 Открыть Infinity Music",
    # --- инлайн
    "inline.listen": "🎧 Слушать в Infinity Music",
    "inline.instrumental": "🎼 Минус",
    "inline.open": "🎧 Открыть Infinity Music",

    # --- поддержка проекта (донаты)
    'menu.donate': '❤️ Поддержать проект',
    'donate.intro': '<b>❤️ Поддержать проект</b>\n\nInfinity Music держится на вашей поддержке — она идёт на сервер, трафик и развитие.\n\nВыберите сумму или укажите свою.\n\n<i>Поддержка добровольная. Это не покупка: взамен ничего не выдаётся — ни Premium, ни бонусов. Возврат не предусмотрен.</i>',
    'donate.custom': '✏️ Своя сумма',
    'donate.top': '🏆 Рейтинг спонсоров',
    'donate.rules': '📄 Правила поддержки',
    'donate.back': '⬅️ Назад',
    'donate.pay': '💳 Перейти к оплате',
    'donate.support_now': '❤️ Поддержать',
    'donate.custom_prompt': '<b>✏️ Своя сумма</b>\n\nНапишите сумму в рублях — от {min} до {max}.\n\n<i>Только целое число, например 300.</i>',
    'donate.bad_amount': 'Не понял сумму. Нужно целое число рублей от {min} до {max} — например 300.\n\nПопробуйте ещё раз или вернитесь назад.',
    'donate.bad_amount_short': 'Такая сумма не поддерживается',
    'donate.pay_prompt': '<b>Поддержка на {amount} ₽</b>\n\nНажмите кнопку — откроется страница оплаты.\n\n<i>После оплаты вернитесь в бот, зачисление придёт автоматически.</i>',
    'donate.unavailable': 'Оплата сейчас недоступна — касса не настроена. Загляните позже.',
    'donate.error': 'Не удалось создать платёж. Попробуйте ещё раз через минуту.',
    'donate.top_title': '<b>🏆 Рейтинг спонсоров</b>\nТоп-{limit} по сумме поддержки',
    'donate.top_empty': '<b>🏆 Рейтинг спонсоров</b>\n\nПока пусто. Вы можете стать первым, кто поддержит проект.',
    'donate.your_place': 'Вы на {rank} месте — {total} ₽. Спасибо!',
    'donate.thanks': '<b>❤️ Спасибо за поддержку!</b>\n\nВаш вклад: <b>{amount} ₽</b>.\nВсего от вас: <b>{total} ₽</b> — {rank} место в рейтинге.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> {percent}%\nСобрано <b>{raised} ₽</b> из <b>{target} ₽</b>',
    'goal.days_left': '⏳ Осталось дней: {days}',
    'goal.last_day': '⏳ Последний день сбора',
    'goal.deadline_over': '⏳ Срок вышел, сбор продолжается',
    'goal.reached': '✅ Цель собрана. Спасибо каждому!',
    'goal.top_title': '<b>🏆 Вклад в цель «{title}»</b>',
    'goal.top_empty': '<b>🏆 Вклад в цель</b>\n\nПока никто не вложился. Вы можете быть первым.',
    'goal.none': 'Сейчас сбора нет — поддержка идёт на сервер и развитие.',
    'goal.switch_all': '🏆 За всё время',
    'goal.switch_goal': '🎯 По текущей цели',
    'goal.open': '🎯 Текущий сбор',
    'goal.support': '❤️ Поддержать сбор',
    'goal.share': '📢 Поделиться сбором',
    'goal.share_send': '📤 Отправить друзьям',
    'goal.share_text': '🎯 Собираем на «{title}» — уже {percent}%. Присоединяйтесь:',
    'goal.post_link': '📢 Пост в канале',
    'goal.share_screen': '<b>📢 Поделиться сбором</b>\n\nЭта ссылка открывает сбор прямо в боте — её можно кинуть другу или выложить в любую соцсеть:\n\n<code>{link}</code>\n\n<i>Нажмите на ссылку, чтобы скопировать.</i>',
    'donate.anon_on': '🙈 Анонимно: включено',
    'donate.anon_off': '👤 Анонимно: выключено',
    'donate.anon_hint': 'Анонимный донат: сумма идёт в прогресс цели, а имя в рейтинге не показывается.',
    'donate.method_title': '<b>Поддержка на {amount} ₽</b>\n\nВыберите, чем платить.',
    'donate.pay_rub': '💳 Картой или СБП',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': 'Поддержка Infinity Music',
    'donate.stars_desc': 'Добровольная поддержка проекта — {amount} ₽. Это не покупка: взамен ничего не выдаётся.',
    'paysupport.text': '<b>💳 Вопросы по оплате</b>\n\nЕсли платёж прошёл по ошибке или что-то пошло не так — напишите в поддержку, разберёмся:\n@{support}\n\n<i>Укажите, когда и на какую сумму был платёж — так мы найдём его быстрее.</i>',
    'donate.ton_prompt': '<b>Поддержка на {amount} ₽ = {ton} TON</b>\n\nНажмите кнопку — откроется кошелёк Telegram.\n\n<i>Зачисление придёт автоматически. Курс зафиксирован на момент создания счёта.</i>',
    'donate.ton_manual': '<b>💎 Поддержка на {amount} ₽ = {ton} TON</b>\n\nПереведите на этот адрес:\n<code>{address}</code>\n\nСумма:\n<code>{ton}</code>\n\n⚠️ <b>Обязательно укажите комментарий</b> — без него мы не поймём, чей это перевод:\n<code>{memo}</code>\n\n<i>Нажмите на строку, чтобы скопировать. Кнопка ниже откроет кошелёк с уже подставленными данными.</i>',
    'donate.ton_open_wallet': '💎 Открыть кошелёк',
    'donate.ton_check': '✅ Я перевёл',
    'donate.ton_not_found': 'Перевода пока не вижу. Он появляется в блокчейне за минуту-другую — попробуйте ещё раз чуть позже.',
    'donate.ton_found': 'Спасибо! Донат на {amount} ₽ зачтён.',
    'donate.ton_unavailable': 'Проверка временно недоступна — блокчейн не отвечает. Деньги не потеряются: перевод зачтётся сам, как только связь вернётся.',
}
