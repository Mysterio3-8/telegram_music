...
MESSAGES: dict[str, str] = {
    ...
    "remind.ends_in_4": "🎧 Premium'un bitmesine {days} gün kaldı.\n\nÜcretsiz uzatabilirsin:",
    "remind.ends_tomorrow": "⏳ Premium yarın bitiyor.\n\nÜcretsiz uzat:",
    "remind.ended": "💎 Premium bitti — ücretsiz geri al:",
    "remind.referral_line": "🤝 Sonraki ödüle kalan arkadaş: {friends} → +{days} gün Premium\nBağlantın: {link}",
    "remind.achievement_line": "🏆 Sıradaki başarı «{title}»: {progress}/{target} → +{days} gün Premium",
    ...
    "album.section": "💿 Albümler",
    "album.button": "💿 {artist} — {title} · {count} parça",
    "album.header": "💿 {artist} — {title}\n{count} parça\n\nBir parça seç ya da albümün tamamını indir.",
    "album.download_all": "⬇️ Albümün tamamını indir ({count})",
    "album.back": "◀️ Sonuçlara dön",
    "album.loading": "💿 Albüm açılıyor…",
    "album.empty": "Albüm açılamadı — daha sonra dene.",
    "album.premium_only": "Albümün tamamı Premium ile. Tek parçalar ücretsiz.",
    "album.premium_button": "💎 Premium'u aç",
    "album.already": "Bir albüm zaten iniyor — bitmesini bekle.",
    "album.queued": "⬇️ «{title}» indiriliyor: {count} parça, yaklaşık {minutes} dk. Hazır oldukça buraya gelecek.",
    "album.progress": "⬇️ «{title}»: {done}/{count}",
    "album.done": "✅ «{title}» hazır: {ok}/{count}.",
    "album.failed": "İndirilemedi: {names}",
    ...
    "player.batch_sent": "🎧 Gönderilen parça: {sent}",
    "player.stop": "⏹ Durdur",
    ...
    # --- donations
    'menu.donate': '❤️ Projeye destek ol',
    'donate.intro': '<b>❤️ Projeye destek ol</b>\n\nInfinity Music desteğinizle ayakta duruyor — sunucu, trafik ve geliştirme masraflarına gidiyor.\n\nBir tutar seçin ya da kendiniz yazın.\n\n<i>Destek gönüllüdür. Bu bir satın alma değildir: karşılığında hiçbir şey verilmez — ne Premium ne de bonus. İade yapılmaz.</i>',
    'donate.custom': '✏️ Kendi tutarım',
    'donate.top': '🏆 Destekçi sıralaması',
    'donate.rules': '📄 Destek koşulları',
    'donate.back': '⬅️ Geri',
    'donate.pay': '💳 Ödemeye geç',
    'donate.support_now': '❤️ Destek ol',
    'donate.custom_prompt': '<b>✏️ Kendi tutarım</b>\n\nRuble cinsinden bir tutar yazın — {min} ile {max} arası.\n\n<i>Yalnızca tam sayı, örneğin 300.</i>',
    'donate.bad_amount': 'Tutarı anlayamadım. {min} ile {max} arasında tam sayı olmalı — örneğin 300.\n\nTekrar deneyin ya da geri dönün.',
    'donate.bad_amount_short': 'Bu tutar desteklenmiyor',
    'donate.pay_prompt': '<b>{amount} ₽ destek</b>\n\nÖdeme sayfasını açmak için düğmeye dokunun.\n\n<i>Sonra bota geri dönün — tutar otomatik olarak işlenir.</i>',
    'donate.unavailable': 'Ödemeler şu anda kullanılamıyor — kasa yapılandırılmamış.',
    'donate.error': 'Ödeme oluşturulamadı. Bir dakika sonra tekrar deneyin.',
    'donate.top_title': '<b>🏆 Destekçi sıralaması</b>\nToplam desteğe göre ilk {limit}',
    'donate.top_empty': '<b>🏆 Destekçi sıralaması</b>\n\nHenüz boş. Projeye destek olan ilk kişi siz olabilirsiniz.',
    'donate.your_place': '{rank}. sıradasınız — {total} ₽. Teşekkürler!',
    'donate.thanks': '<b>❤️ Desteğiniz için teşekkürler!</b>\n\nKatkınız: <b>{amount} ₽</b>.\nSizden toplam: <b>{total} ₽</b> — {rank}. sıra.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> %{percent}\nToplanan <b>{raised} ₽</b> / <b>{target} ₽</b>',
    'goal.days_left': '⏳ Kalan gün: {days}',
    'goal.last_day': '⏳ Kampanyanın son günü',
    'goal.deadline_over': '⏳ Süre doldu, toplama sürüyor',
    'goal.reached': '✅ Hedefe ulaşıldı. Herkese teşekkürler!',
    'goal.top_title': '<b>🏆 «{title}» hedefine katkılar</b>',
    'goal.top_empty': '<b>🏆 Katkılar</b>\n\nHenüz kimse katkıda bulunmadı. İlk siz olabilirsiniz.',
    'goal.none': 'Şu anda kampanya yok — destek sunucuya ve geliştirmeye gidiyor.',
    'goal.switch_all': '🏆 Tüm zamanlar',
    'goal.switch_goal': '🎯 Güncel hedef',
    'goal.open': '🎯 Güncel kampanya',
    'goal.support': '❤️ Kampanyayı destekle',
    'goal.share': '📢 Kampanyayı paylaş',
    'goal.share_send': '📤 Arkadaşlara gönder',
    'goal.share_text': '🎯 «{title}» için toplama yapıyoruz — şimdiden %{percent}. Katılın:',
    'goal.post_link': '📢 Kanaldaki gönderi',
    'goal.share_screen': '<b>📢 Kampanyayı paylaş</b>\n\nBu bağlantı kampanyayı doğrudan botta açar — arkadaşınıza gönderin ya da herhangi bir sosyal ağda paylaşın:\n\n<code>{link}</code>\n\n<i>Kopyalamak için bağlantıya dokunun.</i>',
    'donate.anon_on': '🙈 Anonim: açık',
    'donate.anon_off': '👤 Anonim: kapalı',
    'donate.anon_hint': 'Anonim bağış: tutar hedefe sayılır, adınız listede görünmez.',
    'donate.method_title': '<b>{amount} ₽ destek</b>\n\nÖdeme yöntemini seçin.',
    'donate.pay_rub': '💳 Kart veya SBP',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': "Infinity Music'i destekle",
    'donate.stars_desc': 'Projeye gönüllü destek — {amount} ₽. Bu bir satın alma değildir: karşılığında hiçbir şey verilmez.',
    'paysupport.text': '<b>💳 Ödeme soruları</b>\n\nBir ödeme yanlışlıkla yapıldıysa veya bir sorun çıktıysa desteğe yazın, çözelim:\n@{support}\n\n<i>Ödemenin ne zaman ve hangi tutarda yapıldığını belirtin — böylece daha hızlı buluruz.</i>',
    'donate.ton_prompt': '<b>{amount} ₽ = {ton} TON destek</b>\n\nDüğmeye dokunun — Telegram cüzdanınız açılır.\n\n<i>Tutar otomatik olarak işlenir. Kur, fatura oluşturulduğu anda sabitlenir.</i>',
    'donate.ton_manual': '<b>💎 {amount} ₽ = {ton} TON destek</b>\n\nBu adrese gönderin:\n<code>{address}</code>\n\nTutar:\n<code>{ton}</code>\n\n⚠️ <b>Yorumu mutlaka ekleyin</b> — onsuz transferin kime ait olduğunu anlayamayız:\n<code>{memo}</code>\n\n<i>Kopyalamak için satıra dokunun. Aşağıdaki düğme cüzdanınızı her şey doldurulmuş halde açar.</i>',
    'donate.ton_open_wallet': '💎 Cüzdanı aç',
    'donate.ton_check': '✅ Gönderdim',
    'donate.ton_not_found': 'Transferi henüz görmüyorum. Zincire bir iki dakika içinde düşer — birazdan tekrar deneyin.',
    'donate.ton_found': 'Teşekkürler! {amount} ₽ tutarında bağış işlendi.',
    'donate.ton_unavailable': 'Kontrol şu anda yapılamıyor — zincir yanıt vermiyor. Hiçbir şey kaybolmaz: bağlantı gelince transfer kendiliğinden işlenecek.',
}
