...
MESSAGES: dict[str, str] = {
    ...
    "original.caption": "🎚 Orijinal kalite: {format}, {size} MB",
    "menu.settings": "⚙️ Ayarlar",
    "settings.title": "<b>⚙️ Ayarlar</b>",
    "settings.quality_hint": "Parçaların geleceği biçim.\n\n<b>MP3</b> — hızlı, küçük, doğrudan Telegram oynatıcısında çalar.\n<b>Orijinal</b> — sanatçının yüklediği dosya, çoğu zaman WAV ya da FLAC. İkinci bir mesajda ayrı dosya olarak gelir, onlarca megabayt tutar ve her parçada bulunmaz: sanatçı indirmeye izin vermediyse her zamanki mp3 gelir.",
    "settings.quality_mp3": "🎵 MP3",
    "settings.quality_original": "🎚 Orijinal (Premium)",
    "settings.quality_premium_only": "Orijinal kalite Premium aboneliğe dahildir.",
    "settings.quality_saved_mp3": "Tamam: parçalar mp3 olarak gelecek",
    "settings.quality_saved_original": "Tamam. Sanatçının indirmeye izin verdiği yerlerde orijinal ikinci mesajda gelecek. İzin vermediği yerlerde her zamanki mp3 kalır.",
