...
MESSAGES: dict[str, str] = {
    ...
    "cabinet.price": "💎 {price} ₽/mes • 7 días gratis",
    "remind.ends_in_4": "🎧 Te quedan {days} días de Premium.\n\nPuedes ampliarlo gratis:",
    "remind.ends_tomorrow": "⏳ Tu Premium termina mañana.\n\nAmplíalo gratis:",
    "remind.ended": "💎 Tu Premium ha terminado — recupéralo gratis:",
    "remind.referral_line": "🤝 Amigos para la próxima recompensa: {friends} → +{days} días de Premium\nTu enlace: {link}",
    "remind.achievement_line": "🏆 Próximo logro «{title}»: {progress}/{target} → +{days} días de Premium",
    ...
    "quick.results_artist_only": "🎵 Sin coincidencia exacta para «{query}». Pistas de {artist}:",
    ...
    "album.section": "💿 Álbumes",
    "album.button": "💿 {artist} — {title} · {count} pist.",
    "album.header": "💿 {artist} — {title}\n{count} pistas\n\nElige una pista o descarga el álbum completo.",
    "album.download_all": "⬇️ Descargar álbum completo ({count})",
    "album.back": "◀️ Volver a los resultados",
    "album.loading": "💿 Abriendo el álbum…",
    "album.empty": "No se pudo abrir el álbum — inténtalo más tarde.",
    "album.premium_only": "El álbum completo requiere Premium. Las pistas sueltas se descargan gratis.",
    "album.premium_button": "💎 Abrir Premium",
    "album.already": "Ya se está descargando un álbum — espera a que termine.",
    "album.queued": "⬇️ Descargando «{title}»: {count} pistas, unos {minutes} min. Llegarán aquí según estén listas.",
    "album.progress": "⬇️ «{title}»: {done} de {count}",
    "album.done": "✅ «{title}» listo: {ok} de {count}.",
    "album.failed": "No se pudo descargar: {names}",
    ...
    # --- donations
    'menu.donate': '❤️ Apoyar el proyecto',
    'donate.intro': '<b>❤️ Apoyar el proyecto</b>\n\nInfinity Music se mantiene con tu apoyo: paga el servidor, el tráfico y el desarrollo.\n\nElige un importe o indica el tuyo.\n\n<i>El apoyo es voluntario. No es una compra: no se entrega nada a cambio, ni Premium ni bonificaciones. No se contemplan devoluciones.</i>',
    'donate.custom': '✏️ Otro importe',
    'donate.top': '🏆 Ranking de patrocinadores',
    'donate.rules': '📄 Condiciones de apoyo',
    'donate.back': '⬅️ Atrás',
    'donate.pay': '💳 Ir al pago',
    'donate.support_now': '❤️ Apoyar',
    'donate.custom_prompt': '<b>✏️ Otro importe</b>\n\nEscribe el importe en rublos, de {min} a {max}.\n\n<i>Solo números enteros, por ejemplo 300.</i>',
    'donate.bad_amount': 'No he entendido el importe. Debe ser un número entero de rublos entre {min} y {max}, por ejemplo 300.\n\nInténtalo de nuevo o vuelve atrás.',
    'donate.bad_amount_short': 'Ese importe no está admitido',
    'donate.pay_prompt': '<b>Apoyo de {amount} ₽</b>\n\nPulsa el botón para abrir la página de pago.\n\n<i>Después vuelve al bot: se acredita automáticamente.</i>',
    'donate.unavailable': 'Los pagos no están disponibles ahora: la caja no está configurada.',
    'donate.error': 'No se ha podido crear el pago. Inténtalo de nuevo en un minuto.',
    'donate.top_title': '<b>🏆 Ranking de patrocinadores</b>\nTop {limit} por apoyo total',
    'donate.top_empty': '<b>🏆 Ranking de patrocinadores</b>\n\nTodavía está vacío. Puedes ser el primero en apoyar el proyecto.',
    'donate.your_place': 'Estás en el puesto {rank} con {total} ₽. ¡Gracias!',
    'donate.thanks': '<b>❤️ ¡Gracias por tu apoyo!</b>\n\nTu aportación: <b>{amount} ₽</b>.\nTotal tuyo: <b>{total} ₽</b>: puesto {rank}.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> {percent}%\nRecaudado <b>{raised} ₽</b> de <b>{target} ₽</b>',
    'goal.days_left': '⏳ Días restantes: {days}',
    'goal.last_day': '⏳ Último día de la campaña',
    'goal.deadline_over': '⏳ Plazo cumplido, la campaña sigue',
    'goal.reached': '✅ Objetivo alcanzado. ¡Gracias a todos!',
    'goal.top_title': '<b>🏆 Aportaciones a «{title}»</b>',
    'goal.top_empty': '<b>🏆 Aportaciones</b>\n\nTodavía nadie ha aportado. Puedes ser el primero.',
    'goal.none': 'Ahora no hay campaña: el apoyo va al servidor y al desarrollo.',
    'goal.switch_all': '🏆 Histórico',
    'goal.switch_goal': '🎯 Objetivo actual',
    'goal.open': '🎯 Campaña actual',
    'goal.support': '❤️ Apoyar la campaña',
    'goal.share': '📢 Compartir la campaña',
    'goal.share_send': '📤 Enviar a amigos',
    'goal.share_text': '🎯 Recaudamos para «{title}»: ya el {percent}%. Únete:',
    'goal.post_link': '📢 Publicación del canal',
    'goal.share_screen': '<b>📢 Compartir la campaña</b>\n\nEste enlace abre la campaña dentro del bot: envíalo a un amigo o publícalo en cualquier red social:\n\n<code>{link}</code>\n\n<i>Toca el enlace para copiarlo.</i>',
    'donate.anon_on': '🙈 Anónimo: activado',
    'donate.anon_off': '👤 Anónimo: desactivado',
    'donate.anon_hint': 'Donación anónima: el importe cuenta para el objetivo, tu nombre no aparece en la lista.',
    'donate.method_title': '<b>Apoyo de {amount} ₽</b>\n\nElige cómo pagar.',
    'donate.pay_rub': '💳 Tarjeta o SBP',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': 'Apoyar Infinity Music',
    'donate.stars_desc': 'Apoyo voluntario al proyecto — {amount} ₽. No es una compra: no se entrega nada a cambio.',
    'paysupport.text': '<b>💳 Dudas sobre pagos</b>\n\nSi un pago se hizo por error o algo salió mal, escribe a soporte y lo resolveremos:\n@{support}\n\n<i>Indica cuándo y por qué importe fue el pago: así lo encontraremos antes.</i>',
    'donate.ton_prompt': '<b>Apoyo de {amount} ₽ = {ton} TON</b>\n\nPulsa el botón: se abrirá tu monedero de Telegram.\n\n<i>Se acreditará automáticamente. El tipo de cambio queda fijado al crear la factura.</i>',
    'donate.ton_manual': '<b>💎 Apoyo de {amount} ₽ = {ton} TON</b>\n\nEnvía a esta dirección:\n<code>{address}</code>\n\nImporte:\n<code>{ton}</code>\n\n⚠️ <b>Incluye el comentario</b>: sin él no sabremos de quién es la transferencia:\n<code>{memo}</code>\n\n<i>Toca una línea para copiarla. El botón de abajo abre tu monedero con todo rellenado.</i>',
    'donate.ton_open_wallet': '💎 Abrir monedero',
    'donate.ton_check': '✅ Ya lo envié',
    'donate.ton_not_found': 'Todavía no veo la transferencia. Aparece en la cadena en uno o dos minutos: inténtalo de nuevo en un momento.',
    'donate.ton_found': '¡Gracias! Se ha registrado una donación de {amount} ₽.',
    'donate.ton_unavailable': 'La comprobación no está disponible: la cadena no responde. No se pierde nada, la transferencia se registrará sola cuando vuelva la conexión.',
}
