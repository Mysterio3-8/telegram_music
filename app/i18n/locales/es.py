...
MESSAGES: dict[str, str] = {
    ...
    "original.caption": "🎚 Calidad original: {format}, {size} MB",
    "menu.settings": "⚙️ Ajustes",
    "settings.title": "<b>⚙️ Ajustes</b>",
    "settings.quality_hint": "El formato en el que llegan las pistas.\n\n<b>MP3</b> — rápido, ligero, suena en el reproductor de Telegram.\n<b>Original</b> — el archivo que subió el autor, a menudo WAV o FLAC. Llega como archivo aparte en un segundo mensaje, pesa decenas de megabytes y no existe para todas las pistas: si el autor no permitió la descarga, recibirás el mp3 de siempre.",
    "settings.quality_mp3": "🎵 MP3",
    "settings.quality_original": "🎚 Original (Premium)",
    "settings.quality_premium_only": "La calidad original está incluida en Premium.",
    "settings.quality_saved_mp3": "Listo: las pistas llegan en mp3",
    "settings.quality_saved_original": "Listo. El original llegará en un segundo mensaje donde el autor permitió la descarga. Donde no, seguirá llegando el mp3 de siempre.",
