...
MESSAGES: dict[str, str] = {
    ...
    "cabinet.price": "💎 {price} ₽/month • 7 days free",
    "remind.ends_in_4": "🎧 {days} days of Premium left.\n\nYou can extend it for free:",
    "remind.ends_tomorrow": "⏳ Your Premium ends tomorrow.\n\nExtend it for free:",
    "remind.ended": "💎 Your Premium has ended — get it back for free:",
    "remind.referral_line": "🤝 Friends to the next reward: {friends} → +{days} days of Premium\nYour link: {link}",
    "remind.achievement_line": "🏆 Next achievement «{title}»: {progress}/{target} → +{days} days of Premium",
    "remind.share_button": "🎁 Share my link",
    "remind.open_player": "🎧 Open player",
    "remind.share_text": "I listen to music in Infinity Music — join me",
    "remind.comeback_trial": "👋 Long time no see! {days} days of Premium are waiting for you in the player — free, no payment, they start on first open.",
    "remind.comeback": "👋 Long time no see! Send me the name of any track — I'll deliver it in a couple of seconds.",
    ...
    "quick.results_artist_only": "🎵 No exact match for «{query}». Here are tracks by {artist}:",
    ...
    "album.button": "💿 {artist} — {title} · {count} tr.",
    "album.header": "💿 {artist} — {title}\n{count} tracks\n\nPick a track or download the whole album.",
    "album.download_all": "⬇️ Download whole album ({count})",
    "album.back": "◀️ Back to results",
    "album.loading": "💿 Opening the album…",
    "album.empty": "Couldn't open the album — try again later.",
    "album.premium_only": "The whole album needs Premium. Single tracks download for free.",
    "album.premium_button": "💎 Open Premium",
    "album.already": "An album is already downloading — wait until it finishes.",
    "album.queued": "⬇️ Downloading «{title}»: {count} tracks, about {minutes} min. They'll arrive here as they're ready.",
    "album.progress": "⬇️ «{title}»: {done} of {count}",
    "album.done": "✅ «{title}» is ready: {ok} of {count}.",
    "album.failed": "Couldn't download: {names}",
    "quick.already_fetching": "Already downloading this track — it arrives in a few seconds",
    "quality.note_high": "🎚 Best available quality · {format} · {size} MB",
    "quality.note_lossless": "🎚 Author's original · {format} · {size} MB",
    "quick.preparing_best": "Preparing the best quality — it'll arrive here",
    "menu.settings": "⚙️ Settings",
    "settings.title": "<b>⚙️ Settings</b>",
    "settings.quality_hint": "The quality your tracks arrive in.\n\n<b>Standard</b> — mp3 128 kbps, what everyone gets today.\n<b>Best</b> — the maximum the source offers: 160 kbps, and for some tracks the author's original file (WAV or FLAC). Takes a few seconds longer and weighs more.",
    "settings.quality_mp3": "🎵 Standard · mp3 128",
    "settings.quality_best": "🎚 Best quality (Premium)",
    "settings.quality_premium_only": "Best quality comes with a Premium subscription.",
    "settings.quality_saved_mp3": "Done: tracks arrive as before",
    "settings.quality_saved_best": "Done. Tracks now arrive at the best the source offers: the author's original where it exists, otherwise 160 kbps instead of 128. Where neither is available you get the usual file — no errors, no waiting.",
    "settings.back": "◀️ Back",
    "settings.cover_hint": "<b>The cover</b> is already embedded in the file and shows in the player. Turn on a separate image if you keep music in your own library.",
    "settings.cover_on": "🖼 Separate cover — on",
    "settings.cover_off": "🖼 Separate cover — off",
    "card.title": "🎧 {title}",
    ...
    "player.next": "▶️ Next",
    "player.batch_sent": "🎧 Tracks sent: {sent}",
    "player.stop": "⏹ Stop",
    ...
    "premium.method_title": "<b>Premium for {label}</b>\n\nHow would you like to pay?\n\n⭐ <b>{stars} Stars</b> — right inside Telegram, no card needed\n💳 <b>{price} ₽</b> — card or SBP",
    "premium.pay_stars": "⭐ Pay {stars} Stars",
    "premium.pay_rub": "💳 Pay {price} ₽",
    ...
    # --- donations
    'menu.donate': '❤️ Support the project',
    'donate.intro': '<b>❤️ Support the project</b>\n\nInfinity Music runs on your support — it pays for the server, traffic and development.\n\nPick an amount or enter your own.\n\n<i>Support is voluntary. This is not a purchase: nothing is given in return — no Premium, no bonuses. Refunds are not provided.</i>',
    'donate.custom': '✏️ Custom amount',
    'donate.top': '🏆 Sponsor ranking',
    'donate.rules': '📄 Support terms',
    'donate.back': '⬅️ Back',
    'donate.pay': '💳 Go to payment',
    'donate.support_now': '❤️ Support',
    'donate.custom_prompt': '<b>✏️ Custom amount</b>\n\nSend an amount in roubles — from {min} to {max}.\n\n<i>Whole number only, for example 300.</i>',
    'donate.bad_amount': "I couldn't read that amount. It must be a whole number of roubles from {min} to {max} — for example 300.\n\nTry again or go back.",
    'donate.bad_amount_short': 'That amount is not supported',
    'donate.pay_prompt': '<b>Support of {amount} ₽</b>\n\nTap the button to open the payment page.\n\n<i>Come back to the bot afterwards — it is credited automatically.</i>',
    'donate.unavailable': 'Payments are unavailable right now — the checkout is not set up.',
    'donate.error': 'Could not create the payment. Please try again in a minute.',
    'donate.top_title': '<b>🏆 Sponsor ranking</b>\nTop {limit} by total support',
    'donate.top_empty': '<b>🏆 Sponsor ranking</b>\n\nEmpty so far. You could be the first to support the project.',
    'donate.your_place': 'You are #{rank} with {total} ₽. Thank you!',
    'donate.thanks': '<b>❤️ Thank you for your support!</b>\n\nYour contribution: <b>{amount} ₽</b>.\nTotal from you: <b>{total} ₽</b> — rank #{rank}.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> {percent}%\nRaised <b>{raised} ₽</b> of <b>{target} ₽</b>',
    'goal.days_left': '⏳ Days left: {days}',
    'goal.last_day': '⏳ Last day of the drive',
    'goal.deadline_over': '⏳ Deadline passed, still collecting',
    'goal.reached': '✅ Goal reached. Thank you, everyone!',
    'goal.top_title': '<b>🏆 Contributions to “{title}”</b>',
    'goal.top_empty': '<b>🏆 Contributions</b>\n\nNobody has chipped in yet. You could be first.',
    'goal.none': 'No drive is running right now — support goes to the server and development.',
    'goal.switch_all': '🏆 All time',
    'goal.switch_goal': '🎯 Current goal',
    'goal.open': '🎯 Current drive',
    'goal.support': '❤️ Support the drive',
    'goal.share': '📢 Share the drive',
    'goal.share_send': '📤 Send to friends',
    'goal.share_text': "🎯 We're raising for “{title}” — {percent}% already. Join in:",
    'goal.post_link': '📢 Post in the channel',
    'goal.share_screen': '<b>📢 Share the drive</b>\n\nThis link opens the drive right inside the bot — send it to a friend or post it on any social network:\n\n<code>{link}</code>\n\n<i>Tap the link to copy it.</i>',
    'donate.anon_on': '🙈 Anonymous: on',
    'donate.anon_off': '👤 Anonymous: off',
    'donate.anon_hint': 'Anonymous donation: the amount counts toward the goal, your name stays off the list.',
    'donate.method_title': '<b>Support of {amount} ₽</b>\n\nChoose how to pay.',
    'donate.pay_rub': '💳 Card or SBP',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': 'Support Infinity Music',
    'donate.stars_desc': 'Voluntary support for the project — {amount} ₽. This is not a purchase: nothing is given in return.',
    'paysupport.text': '<b>💳 Payment questions</b>\n\nIf a payment went through by mistake or something went wrong, message our support and we will sort it out:\n@{support}\n\n<i>Mention when the payment was made and the amount — it helps us find it faster.</i>',
    'donate.ton_prompt': '<b>Support of {amount} ₽ = {ton} TON</b>\n\nTap the button — your Telegram wallet will open.\n\n<i>It will be credited automatically. The rate is fixed at the moment the invoice was created.</i>',
    'donate.ton_manual': '<b>💎 Support of {amount} ₽ = {ton} TON</b>\n\nSend to this address:\n<code>{address}</code>\n\nAmount:\n<code>{ton}</code>\n\n⚠️ <b>Be sure to include the comment</b> — without it we cannot tell whose transfer it is:\n<code>{memo}</code>\n\n<i>Tap a line to copy it. The button below opens your wallet with everything pre-filled.</i>',
    'donate.ton_open_wallet': '💎 Open wallet',
    'donate.ton_check': '✅ I have sent it',
    'donate.ton_not_found': 'No transfer yet. It shows up on the blockchain within a minute or two — try again shortly.',
    'donate.ton_found': 'Thank you! A donation of {amount} ₽ has been credited.',
    'donate.ton_unavailable': 'The check is unavailable right now — the blockchain is not responding. Nothing is lost: your transfer will be credited automatically once the connection is back.',
}
