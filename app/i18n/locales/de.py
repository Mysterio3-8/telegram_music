...
MESSAGES: dict[str, str] = {
    ...
    "original.caption": "🎚 Originalqualität: {format}, {size} MB",
    "menu.settings": "⚙️ Einstellungen",
    "settings.title": "<b>⚙️ Einstellungen</b>",
    "settings.quality_hint": "Das Format, in dem Titel ankommen.\n\n<b>MP3</b> — schnell, klein, spielt direkt im Telegram-Player.\n<b>Original</b> — die Datei, die der Autor hochgeladen hat, oft WAV oder FLAC. Sie kommt als eigene Datei in einer zweiten Nachricht, wiegt zig Megabyte und gibt es nicht bei jedem Titel: wo der Autor den Download gesperrt hat, kommt das gewohnte mp3.",
    "settings.quality_mp3": "🎵 MP3",
    "settings.quality_original": "🎚 Original (Premium)",
    "settings.quality_premium_only": "Originalqualität gehört zum Premium-Abo.",
    "settings.quality_saved_mp3": "Fertig: Titel kommen als mp3",
    "settings.quality_saved_original": "Fertig. Das Original kommt in einer zweiten Nachricht, wo der Autor den Download erlaubt hat. Sonst bleibt es beim gewohnten mp3.",
