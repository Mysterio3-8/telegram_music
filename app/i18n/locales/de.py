...
MESSAGES: dict[str, str] = {
    ...
    "remind.ends_in_4": "🎧 Noch {days} Tage Premium.\n\nDu kannst es kostenlos verlängern:",
    "remind.ends_tomorrow": "⏳ Dein Premium endet morgen.\n\nVerlängere es kostenlos:",
    "remind.ended": "💎 Dein Premium ist abgelaufen — hol es dir kostenlos zurück:",
    "remind.referral_line": "🤝 Freunde bis zur nächsten Belohnung: {friends} → +{days} Tage Premium\nDein Link: {link}",
    "remind.achievement_line": "🏆 Nächster Erfolg «{title}»: {progress}/{target} → +{days} Tage Premium",
    "remind.share_button": "🎁 Link teilen",
    "remind.open_player": "🎧 Player öffnen",
    "remind.share_text": "Ich höre Musik mit Infinity Music — komm dazu",
    "remind.comeback_trial": "👋 Lange nicht gesehen! Im Player warten {days} Tage Premium gratis auf dich — ohne Zahlung, sie starten beim ersten Öffnen.",
    "remind.comeback": "👋 Lange nicht gesehen! Schick mir den Namen eines beliebigen Songs — ich liefere ihn in wenigen Sekunden.",
    ...
    "menu.playlists": "🗂 Meine Playlists",
    ...
    "quick.results_artist_only": "🎵 Keine genaue Übereinstimmung für «{query}». Titel von {artist}:",
    ...
    "album.section": "💿 Alben",
    "album.button": "💿 {artist} — {title} · {count} Titel",
    "album.header": "💿 {artist} — {title}\n{count} Titel\n\nWähle einen Titel oder lade das ganze Album.",
    "album.download_all": "⬇️ Ganzes Album laden ({count})",
    "album.back": "◀️ Zurück zu den Ergebnissen",
    "album.loading": "💿 Album wird geöffnet…",
    "album.empty": "Album konnte nicht geöffnet werden — versuch es später.",
    "album.premium_only": "Das ganze Album gibt es mit Premium. Einzelne Titel sind kostenlos.",
    "album.premium_button": "💎 Premium öffnen",
    "album.already": "Ein Album wird bereits geladen — warte, bis es fertig ist.",
    "album.queued": "⬇️ Lade «{title}»: {count} Titel, etwa {minutes} Min. Sie kommen hierher, sobald sie fertig sind.",
    "album.progress": "⬇️ «{title}»: {done} von {count}",
    "album.done": "✅ «{title}» fertig: {ok} von {count}.",
    "album.failed": "Nicht geladen: {names}",
    "quick.already_fetching": "Dieser Titel wird bereits geladen — er kommt in ein paar Sekunden",
    "quality.note_high": "🎚 Beste verfügbare Qualität · {format} · {size} MB",
    "quality.note_lossless": "🎚 Original des Autors · {format} · {size} MB",
    "quick.preparing_best": "Beste Qualität wird vorbereitet — kommt hierher",
    "menu.settings": "⚙️ Einstellungen",
    "settings.title": "<b>⚙️ Einstellungen</b>",
    "settings.quality_hint": "Die Qualität, in der Titel ankommen.\n\n<b>Normal</b> — mp3 128 kbps, was heute alle bekommen.\n<b>Beste</b> — das Maximum der Quelle: 160 kbps und bei manchen Titeln die Originaldatei des Autors (WAV oder FLAC). Dauert ein paar Sekunden länger und wiegt mehr.",
    "settings.quality_mp3": "🎵 Normal · mp3 128",
    "settings.quality_best": "🎚 Beste Qualität (Premium)",
    "settings.quality_premium_only": "Beste Qualität gehört zum Premium-Abo.",
    "settings.quality_saved_mp3": "Fertig: Titel kommen wie bisher",
    "settings.quality_saved_best": "Fertig. Titel kommen jetzt in dem Besten, was die Quelle hergibt: das Original des Autors, wo es existiert, sonst 160 statt 128 kbps. Gibt es beides nicht, kommt die gewohnte Datei — ohne Fehler und ohne Warten.",
    "settings.back": "◀️ Zurück",
    "settings.cover_hint": "<b>Das Cover</b> steckt bereits in der Datei und erscheint im Player. Als eigenes Bild lohnt es sich, wenn du Musik in deiner Mediathek sammelst.",
    "settings.cover_on": "🖼 Cover separat — an",
    "settings.cover_off": "🖼 Cover separat — aus",
    "card.title": "🎧 {title}",
    ...
    "player.batch_sent": "🎧 Gesendete Titel: {sent}",
    "player.stop": "⏹ Stopp",
    ...
    "premium.method_title": "<b>Premium für {label}</b>\n\nWie möchtest du zahlen?\n\n⭐ <b>{stars} Stars</b> — direkt in Telegram, ohne Karte\n💳 <b>{price} ₽</b> — Karte oder SBP",
    "premium.pay_stars": "⭐ {stars} Stars zahlen",
    "premium.pay_rub": "💳 {price} ₽ zahlen",
    ...
    # --- donations
    'menu.donate': '❤️ Projekt unterstützen',
    'donate.intro': '<b>❤️ Projekt unterstützen</b>\n\nInfinity Music lebt von eurer Unterstützung — sie zahlt Server, Traffic und Entwicklung.\n\nWähle einen Betrag oder gib deinen eigenen an.\n\n<i>Die Unterstützung ist freiwillig. Es ist kein Kauf: Es gibt nichts dafür — kein Premium, keine Boni. Eine Rückerstattung ist nicht vorgesehen.</i>',
    'donate.custom': '✏️ Eigener Betrag',
    'donate.top': '🏆 Sponsoren-Rangliste',
    'donate.rules': '📄 Unterstützungsbedingungen',
    'donate.back': '⬅️ Zurück',
    'donate.pay': '💳 Zur Zahlung',
    'donate.support_now': '❤️ Unterstützen',
    'donate.custom_prompt': '<b>✏️ Eigener Betrag</b>\n\nSchicke einen Betrag in Rubel — von {min} bis {max}.\n\n<i>Nur ganze Zahlen, zum Beispiel 300.</i>',
    'donate.bad_amount': 'Ich konnte den Betrag nicht lesen. Es muss eine ganze Zahl in Rubel zwischen {min} und {max} sein — zum Beispiel 300.\n\nVersuche es erneut oder geh zurück.',
    'donate.bad_amount_short': 'Dieser Betrag wird nicht unterstützt',
    'donate.pay_prompt': '<b>Unterstützung über {amount} ₽</b>\n\nTippe auf den Button, um die Zahlungsseite zu öffnen.\n\n<i>Komm danach zurück in den Bot — die Gutschrift erfolgt automatisch.</i>',
    'donate.unavailable': 'Zahlungen sind gerade nicht möglich — die Kasse ist nicht eingerichtet.',
    'donate.error': 'Die Zahlung konnte nicht erstellt werden. Versuche es in einer Minute erneut.',
    'donate.top_title': '<b>🏆 Sponsoren-Rangliste</b>\nTop {limit} nach Gesamtunterstützung',
    'donate.top_empty': '<b>🏆 Sponsoren-Rangliste</b>\n\nNoch leer. Du könntest der Erste sein, der das Projekt unterstützt.',
    'donate.your_place': 'Du bist auf Platz {rank} mit {total} ₽. Danke!',
    'donate.thanks': '<b>❤️ Danke für deine Unterstützung!</b>\n\nDein Beitrag: <b>{amount} ₽</b>.\nInsgesamt von dir: <b>{total} ₽</b> — Platz {rank}.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> {percent}%\nGesammelt <b>{raised} ₽</b> von <b>{target} ₽</b>',
    'goal.days_left': '⏳ Verbleibende Tage: {days}',
    'goal.last_day': '⏳ Letzter Tag der Sammlung',
    'goal.deadline_over': '⏳ Frist abgelaufen, Sammlung läuft weiter',
    'goal.reached': '✅ Ziel erreicht. Danke an alle!',
    'goal.top_title': '<b>🏆 Beiträge zum Ziel „{title}“</b>',
    'goal.top_empty': '<b>🏆 Beiträge</b>\n\nNoch hat niemand beigetragen. Du kannst der Erste sein.',
    'goal.none': 'Derzeit läuft keine Sammlung — die Unterstützung geht an Server und Entwicklung.',
    'goal.switch_all': '🏆 Gesamt',
    'goal.switch_goal': '🎯 Aktuelles Ziel',
    'goal.open': '🎯 Aktuelle Sammlung',
    'goal.support': '❤️ Sammlung unterstützen',
    'goal.share': '📢 Sammlung teilen',
    'goal.share_send': '📤 An Freunde senden',
    'goal.share_text': '🎯 Wir sammeln für „{title}“ — schon {percent}%. Mach mit:',
    'goal.post_link': '📢 Beitrag im Kanal',
    'goal.share_screen': '<b>📢 Sammlung teilen</b>\n\nDieser Link öffnet die Sammlung direkt im Bot — schick ihn einem Freund oder poste ihn in jedem sozialen Netzwerk:\n\n<code>{link}</code>\n\n<i>Tippe auf den Link, um ihn zu kopieren.</i>',
    'donate.anon_on': '🙈 Anonym: an',
    'donate.anon_off': '👤 Anonym: aus',
    'donate.anon_hint': 'Anonyme Spende: Der Betrag zählt zum Ziel, dein Name bleibt aus der Liste.',
    'donate.method_title': '<b>Unterstützung über {amount} ₽</b>\n\nWähle die Zahlungsart.',
    'donate.pay_rub': '💳 Karte oder SBP',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': 'Infinity Music unterstützen',
    'donate.stars_desc': 'Freiwillige Unterstützung des Projekts — {amount} ₽. Das ist kein Kauf: Es gibt keine Gegenleistung.',
    'paysupport.text': '<b>💳 Fragen zur Zahlung</b>\n\nFalls eine Zahlung versehentlich erfolgt ist oder etwas schiefging, schreib dem Support — wir klären das:\n@{support}\n\n<i>Nenne Zeitpunkt und Betrag der Zahlung — so finden wir sie schneller.</i>',
    'donate.ton_prompt': '<b>Unterstützung über {amount} ₽ = {ton} TON</b>\n\nTippe auf den Button — dein Telegram-Wallet öffnet sich.\n\n<i>Die Gutschrift erfolgt automatisch. Der Kurs ist auf den Zeitpunkt der Rechnung festgelegt.</i>',
    'donate.ton_manual': '<b>💎 Unterstützung über {amount} ₽ = {ton} TON</b>\n\nSende an diese Adresse:\n<code>{address}</code>\n\nBetrag:\n<code>{ton}</code>\n\n⚠️ <b>Gib unbedingt den Kommentar an</b> — ohne ihn erkennen wir nicht, von wem die Überweisung stammt:\n<code>{memo}</code>\n\n<i>Tippe auf eine Zeile, um sie zu kopieren. Der Button unten öffnet deine Wallet mit allem vorausgefüllt.</i>',
    'donate.ton_open_wallet': '💎 Wallet öffnen',
    'donate.ton_check': '✅ Ich habe gesendet',
    'donate.ton_not_found': 'Noch keine Überweisung zu sehen. Sie erscheint innerhalb von ein bis zwei Minuten in der Blockchain — versuch es gleich noch einmal.',
    'donate.ton_found': 'Danke! Eine Spende über {amount} ₽ wurde gutgeschrieben.',
    'donate.ton_unavailable': 'Die Prüfung ist gerade nicht möglich — die Blockchain antwortet nicht. Es geht nichts verloren: die Überweisung wird automatisch gutgeschrieben, sobald die Verbindung zurück ist.',
}
