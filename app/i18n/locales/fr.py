...
MESSAGES: dict[str, str] = {
    ...
    "original.caption": "🎚 Qualité originale : {format}, {size} Mo",
    "menu.settings": "⚙️ Réglages",
    "settings.title": "<b>⚙️ Réglages</b>",
    "settings.quality_hint": "Le format dans lequel arrivent les morceaux.\n\n<b>MP3</b> — rapide, léger, se lit dans le lecteur Telegram.\n<b>Original</b> — le fichier déposé par l'auteur, souvent WAV ou FLAC. Il arrive en fichier séparé dans un second message, pèse des dizaines de mégaoctets et n'existe pas pour tous les morceaux : si l'auteur a bloqué le téléchargement, vous recevez le mp3 habituel.",
    "settings.quality_mp3": "🎵 MP3",
    "settings.quality_original": "🎚 Original (Premium)",
    "settings.quality_premium_only": "La qualité originale fait partie de l'abonnement Premium.",
    "settings.quality_saved_mp3": "C'est fait : les morceaux arrivent en mp3",
    "settings.quality_saved_original": "C'est fait. L'original arrivera dans un second message là où l'auteur a autorisé le téléchargement. Sinon, ce sera le mp3 habituel.",
