...
MESSAGES: dict[str, str] = {
    ...
    "cabinet.price": "💎 {price} ₽/mois • 7 jours offerts",
    "remind.ends_in_4": "🎧 Il reste {days} jours de Premium.\n\nVous pouvez le prolonger gratuitement :",
    "remind.ends_tomorrow": "⏳ Votre Premium se termine demain.\n\nProlongez-le gratuitement :",
    "remind.ended": "💎 Votre Premium est terminé — récupérez-le gratuitement :",
    "remind.referral_line": "🤝 Amis avant la prochaine récompense : {friends} → +{days} jours de Premium\nVotre lien : {link}",
    "remind.achievement_line": "🏆 Prochain succès «{title}» : {progress}/{target} → +{days} jours de Premium",
    "remind.share_button": "🎁 Partager mon lien",
    "remind.open_player": "🎧 Ouvrir le lecteur",
    "remind.share_text": "J'écoute de la musique sur Infinity Music — rejoins-moi",
    "remind.comeback_trial": "👋 Ça fait longtemps ! {days} jours de Premium gratuits t'attendent dans le lecteur — sans paiement, ils démarrent à la première ouverture.",
    "remind.comeback": "👋 Ça fait longtemps ! Envoie-moi le nom de n'importe quel morceau — je te l'envoie en quelques secondes.",
    ...
    "album.button": "💿 {artist} — {title} · {count} titres",
    "album.header": "💿 {artist} — {title}\n{count} titres\n\nChoisis un titre ou télécharge l'album entier.",
    "album.download_all": "⬇️ Télécharger l'album entier ({count})",
    "album.back": "◀️ Retour aux résultats",
    "album.loading": "💿 Ouverture de l'album…",
    "album.empty": "Impossible d'ouvrir l'album — réessaie plus tard.",
    "album.premium_only": "L'album entier est réservé à Premium. Les titres seuls sont gratuits.",
    "album.premium_button": "💎 Ouvrir Premium",
    "album.already": "Un album est déjà en téléchargement — attends la fin.",
    "album.queued": "⬇️ Je télécharge «{title}» : {count} titres, environ {minutes} min. Ils arrivent ici au fur et à mesure.",
    "album.progress": "⬇️ «{title}» : {done} sur {count}",
    "album.done": "✅ «{title}» prêt : {ok} sur {count}.",
    "album.failed": "Non téléchargés : {names}",
    ...
    "settings.cover_hint": "<b>La pochette</b> est déjà intégrée au fichier et visible dans le lecteur. Activez l'image séparée si vous rangez la musique dans votre médiathèque.",
    "settings.cover_on": "🖼 Pochette à part — activée",
    "settings.cover_off": "🖼 Pochette à part — désactivée",
    "card.title": "🎧 {title}",
    ...
    "player.batch_sent": "🎧 Titres envoyés : {sent}",
    "player.stop": "⏹ Arrêter",
    ...
    "premium.method_title": "<b>Premium pour {label}</b>\n\nComment souhaitez-vous payer ?\n\n⭐ <b>{stars} Stars</b> — directement dans Telegram, sans carte\n💳 <b>{price} ₽</b> — carte ou SBP",
    "premium.pay_stars": "⭐ Payer {stars} Stars",
    "premium.pay_rub": "💳 Payer {price} ₽",
    ...
    # --- donations
    'menu.donate': '❤️ Soutenir le projet',
    'donate.intro': "<b>❤️ Soutenir le projet</b>\n\nInfinity Music tient grâce à votre soutien : il paie le serveur, le trafic et le développement.\n\nChoisissez un montant ou indiquez le vôtre.\n\n<i>Le soutien est volontaire. Ce n'est pas un achat : rien n'est donné en retour, ni Premium ni bonus. Aucun remboursement n'est prévu.</i>",
    'donate.custom': '✏️ Montant libre',
    'donate.top': '🏆 Classement des sponsors',
    'donate.rules': '📄 Conditions de soutien',
    'donate.back': '⬅️ Retour',
    'donate.pay': '💳 Aller au paiement',
    'donate.support_now': '❤️ Soutenir',
    'donate.custom_prompt': '<b>✏️ Montant libre</b>\n\nEnvoyez un montant en roubles — de {min} à {max}.\n\n<i>Nombre entier uniquement, par exemple 300.</i>',
    'donate.bad_amount': "Je n'ai pas compris le montant. Il faut un nombre entier de roubles entre {min} et {max} — par exemple 300.\n\nRéessayez ou revenez en arrière.",
    'donate.bad_amount_short': "Ce montant n'est pas accepté",
    'donate.pay_prompt': '<b>Soutien de {amount} ₽</b>\n\nAppuyez sur le bouton pour ouvrir la page de paiement.\n\n<i>Revenez ensuite dans le bot : le crédit est automatique.</i>',
    'donate.unavailable': "Les paiements sont indisponibles : la caisse n'est pas configurée.",
    'donate.error': 'Impossible de créer le paiement. Réessayez dans une minute.',
    'donate.top_title': '<b>🏆 Classement des sponsors</b>\nTop {limit} par soutien total',
    'donate.top_empty': '<b>🏆 Classement des sponsors</b>\n\nEncore vide. Vous pourriez être le premier à soutenir le projet.',
    'donate.your_place': 'Vous êtes {rank}e avec {total} ₽. Merci !',
    'donate.thanks': '<b>❤️ Merci pour votre soutien !</b>\n\nVotre contribution : <b>{amount} ₽</b>.\nTotal de votre part : <b>{total} ₽</b> — {rank}e place.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> {percent}%\nCollecté <b>{raised} ₽</b> sur <b>{target} ₽</b>',
    'goal.days_left': '⏳ Jours restants : {days}',
    'goal.last_day': '⏳ Dernier jour de la collecte',
    'goal.deadline_over': '⏳ Délai dépassé, la collecte continue',
    'goal.reached': '✅ Objectif atteint. Merci à tous !',
    'goal.top_title': '<b>🏆 Contributions à « {title} »</b>',
    'goal.top_empty': '<b>🏆 Contributions</b>\n\nPersonne n’a encore contribué. Vous pouvez être le premier.',
    'goal.none': 'Aucune collecte en cours — le soutien va au serveur et au développement.',
    'goal.switch_all': '🏆 Depuis le début',
    'goal.switch_goal': '🎯 Objectif en cours',
    'goal.open': '🎯 Collecte en cours',
    'goal.support': '❤️ Soutenir la collecte',
    'goal.share': '📢 Partager la collecte',
    'goal.share_send': '📤 Envoyer à des amis',
    'goal.share_text': '🎯 Nous collectons pour « {title} » — déjà {percent}%. Rejoignez-nous :',
    'goal.post_link': '📢 Publication du canal',
    'goal.share_screen': '<b>📢 Partager la collecte</b>\n\nCe lien ouvre la collecte directement dans le bot — envoyez-le à un ami ou publiez-le sur n’importe quel réseau social :\n\n<code>{link}</code>\n\n<i>Appuyez sur le lien pour le copier.</i>',
    'donate.anon_on': '🙈 Anonyme : activé',
    'donate.anon_off': '👤 Anonyme : désactivé',
    'donate.anon_hint': 'Don anonyme : le montant compte pour l’objectif, votre nom n’apparaît pas dans la liste.',
    'donate.method_title': '<b>Soutien de {amount} ₽</b>\n\nChoisissez le moyen de paiement.',
    'donate.pay_rub': '💳 Carte ou SBP',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': 'Soutenir Infinity Music',
    'donate.stars_desc': 'Soutien volontaire au projet — {amount} ₽. Ce n’est pas un achat : rien n’est fourni en échange.',
    'paysupport.text': '<b>💳 Questions de paiement</b>\n\nSi un paiement est passé par erreur ou si quelque chose s’est mal passé, écrivez au support, nous réglerons cela :\n@{support}\n\n<i>Indiquez la date et le montant du paiement — nous le retrouverons plus vite.</i>',
    'donate.ton_prompt': '<b>Soutien de {amount} ₽ = {ton} TON</b>\n\nAppuyez sur le bouton : votre portefeuille Telegram s’ouvrira.\n\n<i>Le crédit sera automatique. Le taux est figé au moment de la création de la facture.</i>',
    'donate.ton_manual': '<b>💎 Soutien de {amount} ₽ = {ton} TON</b>\n\nEnvoyez à cette adresse :\n<code>{address}</code>\n\nMontant :\n<code>{ton}</code>\n\n⚠️ <b>Indiquez impérativement le commentaire</b> — sans lui, nous ne saurons pas de qui vient le virement :\n<code>{memo}</code>\n\n<i>Appuyez sur une ligne pour la copier. Le bouton ci-dessous ouvre votre portefeuille avec tout pré-rempli.</i>',
    'donate.ton_open_wallet': '💎 Ouvrir le portefeuille',
    'donate.ton_check': '✅ J’ai envoyé',
    'donate.ton_not_found': 'Aucun virement pour l’instant. Il apparaît sur la chaîne en une à deux minutes — réessayez dans un moment.',
    'donate.ton_found': 'Merci ! Un don de {amount} ₽ a été crédité.',
    'donate.ton_unavailable': 'La vérification est indisponible : la chaîne ne répond pas. Rien n’est perdu, le virement sera crédité automatiquement dès le retour de la connexion.',
}
