...
MESSAGES: dict[str, str] = {
    ...
    "cabinet.price": "💎 {price} ₽/mês • 7 dias grátis",
    "remind.ends_in_4": "🎧 Restam {days} dias de Premium.\n\nVocê pode estender de graça:",
    "remind.ends_tomorrow": "⏳ Seu Premium termina amanhã.\n\nEstenda de graça:",
    "remind.ended": "💎 Seu Premium acabou — recupere de graça:",
    "remind.referral_line": "🤝 Amigos até a próxima recompensa: {friends} → +{days} dias de Premium\nSeu link: {link}",
    "remind.achievement_line": "🏆 Próxima conquista «{title}»: {progress}/{target} → +{days} dias de Premium",
    "remind.share_button": "🎁 Compartilhar meu link",
    "remind.open_player": "🎧 Abrir player",
    "remind.share_text": "Ouço música no Infinity Music — vem comigo",
    "remind.comeback_trial": "👋 Quanto tempo! {days} dias de Premium grátis te esperam no player — sem pagamento, ativam na primeira abertura.",
    "remind.comeback": "👋 Quanto tempo! Me mande o nome de qualquer música — eu envio em poucos segundos.",
    ...
    "album.section": "💿 Álbuns",
    "album.button": "💿 {artist} — {title} · {count} faixas",
    "album.header": "💿 {artist} — {title}\n{count} faixas\n\nEscolhe uma faixa ou descarrega o álbum inteiro.",
    "album.download_all": "⬇️ Descarregar álbum inteiro ({count})",
    "album.back": "◀️ Voltar aos resultados",
    "album.loading": "💿 A abrir o álbum…",
    "album.empty": "Não foi possível abrir o álbum — tenta mais tarde.",
    "album.premium_only": "O álbum inteiro é com Premium. Faixas soltas são grátis.",
    "album.premium_button": "💎 Abrir Premium",
    "album.already": "Já há um álbum a descarregar — espera que termine.",
    "album.queued": "⬇️ A descarregar «{title}»: {count} faixas, cerca de {minutes} min. Chegam aqui à medida que ficam prontas.",
    "album.progress": "⬇️ «{title}»: {done} de {count}",
    "album.done": "✅ «{title}» pronto: {ok} de {count}.",
    "album.failed": "Não foi possível descarregar: {names}",
    ...
    "player.batch_sent": "🎧 Faixas enviadas: {sent}",
    "player.stop": "⏹ Parar",
    ...
    # --- donations
    'menu.donate': '❤️ Apoiar o projeto',
    'donate.intro': '<b>❤️ Apoiar o projeto</b>\n\nO Infinity Music vive do seu apoio — ele paga o servidor, o tráfego e o desenvolvimento.\n\nEscolha um valor ou indique o seu.\n\n<i>O apoio é voluntário. Não é uma compra: nada é dado em troca, nem Premium nem bónus. Não há reembolso.</i>',
    'donate.custom': '✏️ Outro valor',
    'donate.top': '🏆 Ranking de patrocinadores',
    'donate.rules': '📄 Termos de apoio',
    'donate.back': '⬅️ Voltar',
    'donate.pay': '💳 Ir para o pagamento',
    'donate.support_now': '❤️ Apoiar',
    'donate.custom_prompt': '<b>✏️ Outro valor</b>\n\nEnvie um valor em rublos — de {min} a {max}.\n\n<i>Apenas números inteiros, por exemplo 300.</i>',
    'donate.bad_amount': 'Não entendi o valor. Tem de ser um número inteiro de rublos entre {min} e {max} — por exemplo 300.\n\nTente outra vez ou volte atrás.',
    'donate.bad_amount_short': 'Esse valor não é aceite',
    'donate.pay_prompt': '<b>Apoio de {amount} ₽</b>\n\nToque no botão para abrir a página de pagamento.\n\n<i>Depois volte ao bot — o crédito é automático.</i>',
    'donate.unavailable': 'Os pagamentos estão indisponíveis — a caixa não está configurada.',
    'donate.error': 'Não foi possível criar o pagamento. Tente novamente dentro de um minuto.',
    'donate.top_title': '<b>🏆 Ranking de patrocinadores</b>\nTop {limit} por apoio total',
    'donate.top_empty': '<b>🏆 Ranking de patrocinadores</b>\n\nAinda vazio. Pode ser o primeiro a apoiar o projeto.',
    'donate.your_place': 'Está em {rank}.º lugar com {total} ₽. Obrigado!',
    'donate.thanks': '<b>❤️ Obrigado pelo seu apoio!</b>\n\nA sua contribuição: <b>{amount} ₽</b>.\nTotal da sua parte: <b>{total} ₽</b> — {rank}.º lugar.',
    'goal.block': '🎯 <b>{title}</b>\n<code>{bar}</code> {percent}%\nArrecadado <b>{raised} ₽</b> de <b>{target} ₽</b>',
    'goal.days_left': '⏳ Dias restantes: {days}',
    'goal.last_day': '⏳ Último dia da campanha',
    'goal.deadline_over': '⏳ Prazo esgotado, a campanha continua',
    'goal.reached': '✅ Meta atingida. Obrigado a todos!',
    'goal.top_title': '<b>🏆 Contribuições para «{title}»</b>',
    'goal.top_empty': '<b>🏆 Contribuições</b>\n\nAinda ninguém contribuiu. Pode ser o primeiro.',
    'goal.none': 'Não há campanha a decorrer — o apoio vai para o servidor e o desenvolvimento.',
    'goal.switch_all': '🏆 Desde sempre',
    'goal.switch_goal': '🎯 Meta atual',
    'goal.open': '🎯 Campanha atual',
    'goal.support': '❤️ Apoiar a campanha',
    'goal.share': '📢 Partilhar a campanha',
    'goal.share_send': '📤 Enviar a amigos',
    'goal.share_text': '🎯 Estamos a angariar para «{title}» — já {percent}%. Junte-se:',
    'goal.post_link': '📢 Publicação no canal',
    'goal.share_screen': '<b>📢 Partilhar a campanha</b>\n\nEste link abre a campanha dentro do bot — envie-o a um amigo ou publique-o em qualquer rede social:\n\n<code>{link}</code>\n\n<i>Toque no link para o copiar.</i>',
    'donate.anon_on': '🙈 Anónimo: ligado',
    'donate.anon_off': '👤 Anónimo: desligado',
    'donate.anon_hint': 'Doação anónima: o valor conta para a meta, o seu nome não aparece na lista.',
    'donate.method_title': '<b>Apoio de {amount} ₽</b>\n\nEscolha como pagar.',
    'donate.pay_rub': '💳 Cartão ou SBP',
    'donate.pay_ton': '💎 TON — {ton}',
    'donate.pay_stars': '⭐ Stars — {stars}',
    'donate.stars_title': 'Apoiar o Infinity Music',
    'donate.stars_desc': 'Apoio voluntário ao projeto — {amount} ₽. Não é uma compra: nada é dado em troca.',
    'paysupport.text': '<b>💳 Dúvidas sobre pagamentos</b>\n\nSe um pagamento foi feito por engano ou algo correu mal, escreva ao suporte e resolvemos:\n@{support}\n\n<i>Indique quando e de que valor foi o pagamento — assim encontramo-lo mais depressa.</i>',
    'donate.ton_prompt': '<b>Apoio de {amount} ₽ = {ton} TON</b>\n\nToque no botão — a sua carteira do Telegram abre-se.\n\n<i>O crédito é automático. A taxa fica fixada no momento em que a fatura foi criada.</i>',
    'donate.ton_manual': '<b>💎 Apoio de {amount} ₽ = {ton} TON</b>\n\nEnvie para este endereço:\n<code>{address}</code>\n\nValor:\n<code>{ton}</code>\n\n⚠️ <b>Inclua obrigatoriamente o comentário</b> — sem ele não sabemos de quem é a transferência:\n<code>{memo}</code>\n\n<i>Toque numa linha para a copiar. O botão abaixo abre a sua carteira com tudo preenchido.</i>',
    'donate.ton_open_wallet': '💎 Abrir carteira',
    'donate.ton_check': '✅ Já enviei',
    'donate.ton_not_found': 'Ainda não vejo a transferência. Aparece na cadeia em um ou dois minutos — tente novamente daqui a pouco.',
    'donate.ton_found': 'Obrigado! Um donativo de {amount} ₽ foi creditado.',
    'donate.ton_unavailable': 'A verificação está indisponível — a cadeia não responde. Nada se perde: a transferência será creditada assim que a ligação voltar.',
}
