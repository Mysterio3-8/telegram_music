...
MESSAGES: dict[str, str] = {
    ...
    "original.caption": "🎚 Qualidade original: {format}, {size} MB",
    "menu.settings": "⚙️ Definições",
    "settings.title": "<b>⚙️ Definições</b>",
    "settings.quality_hint": "O formato em que as faixas chegam.\n\n<b>MP3</b> — rápido, leve, toca no leitor do Telegram.\n<b>Original</b> — o ficheiro que o autor carregou, muitas vezes WAV ou FLAC. Chega como ficheiro à parte numa segunda mensagem, pesa dezenas de megabytes e não existe em todas as faixas: se o autor não permitiu a descarga, recebe o mp3 do costume.",
    "settings.quality_mp3": "🎵 MP3",
    "settings.quality_original": "🎚 Original (Premium)",
    "settings.quality_premium_only": "A qualidade original faz parte da subscrição Premium.",
    "settings.quality_saved_mp3": "Pronto: as faixas chegam em mp3",
    "settings.quality_saved_original": "Pronto. O original chega numa segunda mensagem onde o autor permitiu a descarga. Onde não permitiu, fica o mp3 do costume.",
