...
class Settings(BaseSettings):
    ...
    # Подобрано по реальной базе (30 148 треков, app.cli.duration_stats):
    # < 60 сек — 10% обрезков и джинглов, > 15 мин — 4,3% подкастов и часовых миксов.
    # Такие границы режут ~14% мусора, не трогая короткие интерлюдии и длинные ремиксы.
    search_min_seconds: int = 60
