...
class Settings(BaseSettings):
    ...
    # 29 ₽ — «символическая» цена месяца (решение владельца): бот бесплатный,
    # подписка открывает Mini App и Premium-плюшки. Временная, пока строим серверы.
    premium_price_rub: int = 29
