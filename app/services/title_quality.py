...
_JUNK_MARKERS = (
    ...
    r"интервью",
    # Живой прогон 25.09 — нашлось в каталоге и в Infinity Mix: английские
    # интервью, документалка, новогоднее поздравление артиста, документальный
    # цикл «Classic Albums», реклама «…смотри пока YouTube не удалил»
    r"interview",
    r"documentary",
    r"поздравлени\w*",
    r"classic\s+albums",
