...
# Пробный доступ к Mini App, один раз на аккаунт. 1 → 7 дней 15.09 (решение
# владельца): замер воронки — 0 живых входов в Mini App и 0 оплат, один день не
# давал человеку дойти до приложения. Mini App включает пробный период сам при
# первом открытии (main.js), без экрана пэйвола.
TRIAL_DAYS = 7
