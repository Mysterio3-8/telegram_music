...
единственный живой. ⚠️ **Живых узлов на деле ОДИН, а не пять**: 10808 и 10813
ведут в один и тот же `proxy-se1`, так что «ротация по пяти входам» была
ротацией по одному узлу. Ожидание из приоритетов «ротация поднимет 3/4 до 4/4»
на этом железе неисполнимо — нужны живые узлы, а не перебор мёртвых.
