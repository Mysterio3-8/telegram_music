...
**Статус:** 🟢 прод (Этапы 1-5 задеплоены, Mini App живой на keybest.cc, 558 тестов)
...
⚠️ **Не сделано, найдено попутно:** инлайн отдаёт только треки с `tg_file_id`, а
96% из них после переезда на @muz_damn_bot мертвы — самолечения там, в отличие от
бота и API, нет. Оживает по мере ночного ремонта каталога.
