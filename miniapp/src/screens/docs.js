...
const DOCS = {
  faq: {
    ...
    blocks: [
      ...
      [
        "Что даёт Premium?",
        "Без рекламы, офлайн-прослушивание, перенос плейлистов пачкой, безлимитные плейлисты и загрузки, эквалайзер и таймер сна, добавление текстов песен. Тарифы — от 21 ₽ в месяц, годовая подписка выгоднее. Первые 7 дней — бесплатно, без карты: пробный период включается сам при первом открытии приложения.",
      ],
      [
