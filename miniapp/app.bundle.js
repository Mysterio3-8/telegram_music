...
// отпечаток исходников: b865bea05dce8d83
      ...
      faq: {
        ...
        blocks: [
          ...
          [
            ...
            "Бесконечная лента: треки из нашей базы вперемешку со свежими из сети, без повторов — что уже звучало на этой неделе, второй раз не попадётся. Хотите подборку под настроение, тип или язык — нажмите «Настроить» в том же блоке: это отдельный микс, основную ленту он не меняет.",
          ],
          [
          ...
          [
            ...
            "Откройте «Плейлисты» с главной или из библиотеки и нажмите «Создать плейлист». В боте без Premium доступно до 5 плейлистов, с Premium — без ограничений.",
          ],
          [
          ...
          [
            ...
            "«Библиотека → Перенести из сервисов» или команда /transfer в боте. Пришлите ссылку на публичный плейлист Spotify, Яндекс Музыки или ВКонтакте. Найдём треки в нашей базе, чего нет — загрузим. ВКонтакте часто закрывает плейлисты без входа в аккаунт — тогда перенос из него не получится.",
          ],
          [
            "Что даёт Premium?",
          ...
          [
            ...
            "Приглашайте друзей по личной ссылке из профиля — за первого друга день Premium, дальше больше, вплоть до пожизненной подписки за 5000 друзей. Засчитываются друзья, которые реально пользуются ботом. Подробности — в разделе «Реферальная программа».",
          ],
          [
      ...
      privacy: {
        ...
        blocks: [
          ...
          [
            ...
            "Данные Telegram-профиля: идентификатор, имя, username, язык и фото профиля — их передаёт Telegram при авторизации. История действий в Сервисе: прослушивания и сколько секунд звучал трек, пропуски, скачивания, поисковые запросы, добавления в библиотеку и плейлисты, открытые экраны приложения. Технические данные: IP-адрес в журналах сервера, тип устройства и версия клиента — для защиты от атак и диагностики ошибок.",
          ],
          [
          ...
          [
            "4. Платежи",
            "Оплата Premium проходит через платёжного провайдера ЮKassa, добровольная поддержка — также через Telegram Stars и TON. Сервис не получает и не хранит данные банковских карт и кошельков — только факт, сумму и способ платежа для активации подписки и учёта поддержки.",
          ],
          [
            "5. Кому передаются данные",
            "Данные не продаются. Чтобы найти трек, текст вашего запроса уходит в открытые музыкальные источники (SoundCloud, YouTube) — без имени, идентификатора и других сведений о вас. Платёжным сервисам передаётся только то, что нужно для платежа. Иным третьим лицам данные не передаются, кроме случаев, прямо предусмотренных законом.",
          ],
          [
            "6. Хранение и защита",
            "Данные хранятся на защищённых серверах, с резервными копиями. Доступ к ним ограничен и есть только у администрации Сервиса; статистика для администрации собирается в обезличенном виде. Настройки рекомендаций, недавние треки и скачанные для офлайна файлы хранятся на вашем устройстве.",
          ],
          [
            "7. Ваши права",
